...
no_paths_df = pd.read_csv(os.path.join("data","no_path_founds.csv"))
distmatrix_df = pd.read_csv(os.path.join("data","distmatrix_contracosta.csv"))
...
# var_prop_served_df = pd.read_csv(os.path.join("results",run_name,"var_prop_served.csv"))
