...
for county, county_fips in ca_counties.items():
    ...
    output_file_name = os.path.join(os.getcwd(), 'data', 'distance_matrices', 'distmatrix_walk_cf' + output_county + '.csv')
    if not(os.path.exists(output_file_name)): # If distance matrix has not been calculated yet
        ...
        if not(os.path.exists(os.path.join(os.getcwd(), 'data', 'graphs', 'graph_walk_cf' + output_county + '.graphml'))): # If graph has not been downloaded yet
            ...
            ox.save_graphml(county_graph, os.path.join(os.getcwd(), 'data', 'graphs', 'graph_walk_cf' + output_county + '.graphml'))
        else: #Load graph from disk
            county_graph = ox.load_graphml(os.path.join(os.getcwd(), 'data', 'graphs', 'graph_walk_cf' + output_county + '.graphml'))
